...
#sys.path.append('../stanford-parser/stanford-parser.jar')
#sys.path.append('../stanford-parser-2012-07-09/stanford-parser.jar')
sys.path.append('/home/manbearpig/Downloads/stanford-parser-full-2013-06-20/stanford-parser.jar')
#sys.path.append('../stanford-parser/stanford-parser-3.2.0-models.jar')

import re, os, string, math
...
class PySentence:
    ...
    def get_least_common_node(self, node_i_idx, node_j_idx):
        ...
        if common_node != None:
            for idx_i in path1:
                shortest_path1.append(idx_i)
                if idx_i == common_node:
                    break
            for idx_i in path2:
                if idx_i == common_node:
                    break
                shortest_path2.append(idx_i)

	shortest_path2.reverse()
	shortest_path = shortest_path1 + shortest_path2
